  ...
  return (
    <section className="relative w-full bg-[#F5EFE7] text-[#111820] overflow-hidden select-none border-t border-[#D5C7B4]/60">
      ...
      <div className="relative z-10 w-full max-w-[1240px] mx-auto py-10 sm:py-14 md:py-16 lg:py-18 flex flex-col md:flex-row items-center justify-center px-6 sm:px-8 gap-8 md:gap-6">
        ...
        <div className="relative w-full md:w-[53%] lg:w-[55%] flex items-center justify-center md:justify-end">
          <ScrollReveal variant="fade-right" delay={120} duration={850} className="w-full flex justify-center md:justify-end">
            <div className="relative w-full max-w-[480px] sm:max-w-[560px] md:max-w-[640px] lg:max-w-[720px] xl:max-w-[760px] aspect-[780/435] min-h-[200px] sm:min-h-[260px] md:min-h-[340px] lg:min-h-[390px]">
              <Image
        ...
        <div className="relative w-full md:w-[47%] lg:w-[45%] flex flex-col justify-center md:pl-4 lg:pl-8">
          <div className="max-w-[490px] w-full mx-auto md:mx-0">
            {/* Antique Gold Accent Bar */}
            <ScrollReveal variant="fade-up" delay={180} duration={600}>
              <div
            ...
            <ScrollReveal variant="fade-up" delay={400} duration={750}>
            ...
            <ScrollReveal variant="fade-up" delay={520} duration={800}>
