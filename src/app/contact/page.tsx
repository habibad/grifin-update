    ...
    <main className="min-h-screen bg-[#0B1117] text-white flex flex-col justify-between">
      ...
      <div className="container-custom flex-1 flex flex-col items-center justify-center pt-32 pb-16 text-center">
        <ScrollReveal variant="fade-up" delay={80} duration={600}>
          <span className="text-[12px] font-bold tracking-[0.2em] text-[#B18A3A] uppercase mb-4 block">
        ...
        <ScrollReveal variant="fade-up" delay={280} duration={750}>
          <p className="font-[var(--font-editorial)] text-xl text-[#F3EFE6]/80 max-w-lg mb-8">
            Get in touch with Jeff & Lynn Griffin regarding leasing, build-to-suit opportunities, or land developments.
          </p>
        </ScrollReveal>
        <ScrollReveal variant="fade-up" delay={380} duration={650}>
          <Link
            href="/"
